...
### SysAdmin | HomeLab Architect | Game Modder

<a href="https://thunderstore.io/c/lethal-company/p/Maxima356/">
  <img src="https://img.shields.io/badge/Thunderstore-Maxima356-success?style=for-the-badge&logo=data:image/png;base64," alt="Thunderstore"/>
</a>
<a href="https://github.com/Maxima356">
  <img src="https://img.shields.io/github/followers/Maxima356?style=for-the-badge&logo=github&color=black" alt="GitHub Followers"/>
</a>

<br/>

**Le jour, je gère mon Cloud et je flash des puces. La nuit, je casse Lethal Company.**
<br/>
Passionné par l'infrastructure robuste, l'automatisation domotique et le modding audio.

</div>

---

### 🎮 Mes Mods (Lethal Company)

Je crée des expériences audio custom pour ajouter du chaos et du fun.

| Mod | Description | Lien |
| :--- | :--- | :---: |
| 🤡 **JesterEditedFree** | Pack audio mème pour le Jester (Hava Nagila, Red Sun in the Sky). | [**Voir**](https://github.com/Maxima356/JesterEditedFree) |
| 🚨 **TriviaEscapeMusic** | Musique d'évasion tribute à Tower Unite (Intensité dynamique). | [**Voir**](https://github.com/Maxima356/TriviaEscapeMusic) |

> 🤝 *Collabore régulièrement avec [@ludvdber](https://github.com/ludvdber).*

---

### 🏗️ L'Arsenal (Infrastructure & HomeLab)

Là où la magie opère. Tout est self-hosted, tout est contrôlé.
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/Zigbee2MQTT-FFC40D?style=for-the-badge&logo=mqtt&logoColor=black" alt="Zigbee2MQTT"/>
